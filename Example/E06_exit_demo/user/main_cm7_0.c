...
// 3.使用杜邦线一端接GND，另外一端接触 P1.0 引脚，会发现 P19.0 LED灯 切换状态
// 4.使用杜邦线一端接GND，另外一端接触 P1.1 引脚，会发现 P19.0 LED灯 切换状态
// 5.使用杜邦线一端接GND，另外一端接触 P2.0 引脚，会发现 P19.0 LED灯 切换状态
// 6.使用杜邦线一端接GND，另外一端接触 P2.1 引脚，会发现 P19.0 LED灯 切换状态
// 如果发现现象与说明严重不符 请参照本文件最下方 例程常见问题说明 进行排查

// **************************** 代码区域 ****************************

#define EXTI_PORT1              (P01_0)
#define EXTI_PORT2              (P01_1)
