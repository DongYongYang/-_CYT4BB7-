...
//      ...
// 5.将 ADC_CHANNELx 宏定义对应的引脚分别接到 3V3GND 再对应的信息会看到数据变化
...
#define ADC_CHANNEL3            (ADC1_CH09_P12_5)
#define ADC_CHANNEL4            (ADC1_CH08_P12_4)

#define ADC_CHANNEL5            (ADC1_CH04_P12_0)
#define ADC_CHANNEL6            (ADC1_CH00_P10_4)
#define ADC_CHANNEL7            (ADC0_CH01_P06_1)
#define ADC_CHANNEL8            (ADC0_CH00_P06_0)
...
// 问题3：显示数值与接入电压相差过大
//      检查信号引脚是否接对，信号线是否松动
//      使用万用表测量实际引脚上电压是多少 然后按照 voltage3V3256 计算
