...
int main(void)
{
    ...
    zf_log(1, "E10_printf_debug_log_demo zf_log with true.");                   // zf_log 宏定义函数使用方法 第一个参数为真则无输出
    zf_log(0, "E10_printf_debug_log_demo zf_log with false.");                  // zf_log 宏定义函数使用方法 第一个参数为假则输出 log
